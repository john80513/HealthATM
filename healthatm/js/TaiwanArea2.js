...
//        zoom: 8,
    ...
    map.data.loadGeoJson("healthatm/中華民國縣市.json");
...
//        infowindow.setContent("<div class='hoverInfo'>" + event.feature.getProperty('population') + "H2U健康ATM 健康指數</div>");
//        infowindow.setContent("<div class='hoverInfo'>" + "H2U健康指數</div>" + event.feature.getProperty('population') );
...
$(function () {
    ...
    $.get('healthatm/人數.txt',function(data){
